...
class $AssetsImagesIconGen {
  ...
  /// File path: assets/images/icon/app_icon.png
  AssetGenImage get appIcon =>
      const AssetGenImage('assets/images/icon/app_icon.png');

  /// File path: assets/images/icon/loading_icon.gif
  AssetGenImage get loadingIcon =>
      const AssetGenImage('assets/images/icon/loading_icon.gif');

  /// List of all assets
  List<AssetGenImage> get values => [appIcon, loadingIcon];
}
